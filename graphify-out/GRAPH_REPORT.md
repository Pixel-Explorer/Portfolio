# Graph Report - Archival app  (2026-06-12)

## Corpus Check
- 90 files · ~173,723 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 996 nodes · 1201 edges · 77 communities (62 shown, 15 thin omitted)
...
Cohesion: 0.06
Nodes (9): BEATS, ERA_COLORS, ColorGrader, ExplodeView, ScrollManager, SelfTest, BG_COLORS, BEAT_TUNING (+1 more)
...
Cohesion: 0.15
Nodes (14): buildFolderSheet(), escapeHtml(), extractLinkedInEmbedUrl(), fact(), formatDate(), getStrongestEntry(), moveTooltip(), openLightbox() (+6 more)
...
## Knowledge Gaps
- **461 isolated node(s):** `data`, `years`, `weeks`, `months`, `weekCells` (+456 more)
